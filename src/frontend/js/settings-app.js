class SettingsApp {
  ...
  loadSettingsToUI() {
    ...
    // Effets visuels
    document.getElementById("visualEffects").checked =
    ...
    // Historique
    document.getElementById("watchHistory").checked =
      this.settings.watchHistory;

    // Suivi de progression
    document.getElementById("trackProgress").checked =
      this.settings.trackProgress;

    // Reprise automatique
    document.getElementById("autoResume").checked = this.settings.autoResume;

    // Lecture auto du prochain épisode
    document.getElementById("autoPlayNext").checked =
      this.settings.autoPlayNext;

    // Délai avant lecture auto
    document.getElementById("autoPlayDelay").value =
  ...
  setupEventListeners() {
    ...
    // Langue par défaut
    document
      .getElementById("defaultLanguage")
  ...
  clearHistory() {
    if (
      confirm(
        "Êtes-vous sûr de vouloir effacer tout l'historique de visionnage ? Cette action est irréversible."
      )
    ) {
      try {
  ...
  /**
   * Configure l'effet de flou du header au scroll
   */
  setupHeaderScroll() {
